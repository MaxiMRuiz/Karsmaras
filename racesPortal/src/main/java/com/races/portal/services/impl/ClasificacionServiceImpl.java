...
public class ClasificacionServiceImpl implements ClasificacionService {
	...
	@Override
	public List<Clasificacion> clasificacionGpEquipos(Long id) {
		List<Clasificacion> listaClasificaciones = new ArrayList<>();

		String url = env.getProperty(Constants.SERVICES_HOST) + env.getProperty("races.services.clasificacion.gp.equipos.buscar") + id;
	...
	@Override
	public List<Clasificacion> clasificacionCampeonatoEquipos(Long id) {
		List<Clasificacion> listaClasificaciones = new ArrayList<>();

		String url = env.getProperty(Constants.SERVICES_HOST) + env.getProperty("races.services.clasificacion.campeonato.equipos.buscar") + id;
