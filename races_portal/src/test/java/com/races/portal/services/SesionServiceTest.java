...
import com.races.portal.services.impl.SesionServiceImpl;
...
public class SesionServiceTest {
	...
	@Test
	public void buscarSesionesTests() {
		try {
			array.put(obj);
			...
			assertNotNull(sesionService.buscarSesiones(TEST, TEST, TEST));
	...
	@Test
	public void buscarSesionesFailTests() {
		try {
